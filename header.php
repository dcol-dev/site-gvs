...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-R6EBQB5Z33"></script>
<script>
        ...
        <div class="container text-center">
          ...
          <div>
            <a href="https://br.linkedin.com/company/grupovaldirsaraiva " target="_blank"><img
                src="img/linkedinlogo.png" alt="" class="img-fluid  m-auto" style="width:30px"></a>
            <a href="https://www.youtube.com/@grupovaldirsaraiva" target="_blank"><img src="img/youtubelogo.png" alt=""
          ...
          <div class="collapse navbar-collapse menu-links " id="navbarSupportedContent">
            <ul class="text-end navbar-nav  m-auto text-center">
              ...
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="trabalhe_conosco.php">TRABALHE CONOSCO</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="Institucional.php">INSTITUCIONAL</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="contato.php">FALE CONOSCO</a>
              </li>
            </ul>
          </div>
        ...
        <div class="collapse navbar-collapse m-auto text-center nav-empresas" id="navbarNavDarkDropdown">
          <div class="dropdown-center">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="emp_dimacol.php"><img class="img-fluid" src="img/logo/Logo Dimacol.png" alt=""></a>
              </li>
              <li><a class="dropdown-item" href="emp_vjc.php"><img class="img-fluid" src="img/logo/Logo-VJC.png" alt=""></a></li>
              <li><a class="dropdown-item" href="emp_mvs.php"><img class="img-fluid" src="img/logo/logo-mvs.png" alt=""></a></li>
            </ul>
          </div>
          ...
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              <button class="btn btn-secondary dropdown-toggle" id="empresas-toggle" type="button"
                data-bs-toggle="dropdown" aria-expanded="false"><img src="img/varejo.png" class="img-fluid rounded-top"
                  alt="">
                Varejo
              </button>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="emp_varejos.php"><img class="img-fluid" src="img/logo/dimacol-varejo.png"
                      alt=""></a></li>
              </ul>
            </div>
          </div>
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="https://cachacapocodapedra.com.br"><img class="img-fluid" src="img/logo/logo-cachaca.png"
                      alt=""></a>
                </li>
              </ul>
            </div>
          ...
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="emp_posto.php"><img class="img-fluid" src="img/logo/logo-posto-radar.png"
                      alt=""></a></li>
              </ul>
            </div>
          </div>
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="emp_hotel.php"><img class="img-fluid" src="img/logo/Logo-Hotel.png" alt=""></a>
                </li>
              </ul>
            </div>
          </div>
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              ...
              <ul class="dropdown-menu text-center">
                <li><a class="dropdown-item" href="emp_aco.php"><img class="img-fluid" src="img/logo/Logo-aco.png" alt=""></a>
                </li>
              </ul>
            </div>
          </div>
          <div class="collapse navbar-collapse m-auto text-center" id="navbarNavDarkDropdown">
            <div class="dropdown-center">
              <button class="btn btn-secondary dropdown-toggle" id="empresas-toggle" type="button"
                data-bs-toggle="dropdown" aria-expanded="false"><img src="img/entrega-rapida.png" alt=""
                  class="img-fluid">
                Camcam
              </button>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="emp_camcam.php"><img class="img-fluid" src="img/logo/Logo-Camcam.png" alt=""></a>
                </li>
              </ul>
            </div>
          </div>
